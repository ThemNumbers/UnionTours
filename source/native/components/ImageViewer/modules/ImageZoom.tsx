...
// TODO: REFACTOR THIS
class ImageZoom extends React.Component<ImageZoomProps, ImageZoomState> {
        ...
        if (new Date().getTime() - this.lastClickTime < (this.props.doubleClickInterval || 0)) {
          ...
          if (this.props.enableDoubleClickZoom) {
            if (this.scale > 1 || this.scale < 1) {
              ...
              this.positionX =
                ((this.props.cropWidth / 2 - this.doubleClickX) * diffScale) / this.scale

              this.positionY =
                ((this.props.cropHeight / 2 - this.doubleClickY) * diffScale) / this.scale
            }
        ...
        if (this.props.panToMove) {
          if (this.swipeDownOffset === 0) {
            ...
            if (this.props.imageWidth * this.scale > this.props.cropWidth) {
              ...
              const horizontalMax =
                (this.props.imageWidth * this.scale - this.props.cropWidth) / 2 / this.scale
  ...
  public panResponderReleaseResolve = (): void => {
    ...
    if (this.props.imageHeight * this.scale > this.props.cropHeight) {
      const verticalMax =
        (this.props.imageHeight * this.scale - this.props.cropHeight) / 2 / this.scale
  ...
  public didCenterOnChange(
    ...
    return (
      params.x !== paramsNext.x || params.y !== paramsNext.y || params.scale !== paramsNext.scale
    )
  }
